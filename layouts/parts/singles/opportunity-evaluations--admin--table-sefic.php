...
<table ng-controller="RegistrationNumberController" class="js-registration-list registrations-table" ng-class="{'registrations-results': data.entity.published}"><!-- adicionar a classe registrations-results quando resultados publicados-->
    <thead>
        <tr>
